...
// Import Ikon
import { ArrowLeftIcon, CalendarDaysIcon, Bars3Icon, TrashIcon } from '@heroicons/react/24/solid';
...
// Komponen Aksi Postingan (Tidak diubah)
...
// Komponen Kartu Postingan dengan Fungsi Hapus (Tidak diubah)
...
// ===================================================================
// 1. PERUBAHAN UTAMA: Menerima 'friendsCount'
// ===================================================================
export default function Show({ user, posts, friendsCount }) {
    const { auth } = usePage().props;
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
    const isMyProfile = auth.user.id === user.id;
                    ...
                    <main className="w-full max-w-none lg:max-w-[600px] min-h-screen border-x-0 lg:border-x border-stone-200">
                        ...
                        <div className="sticky top-0 bg-light-bg/80 backdrop-blur-md z-20 px-4 py-3 border-b border-stone-200 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-stone-500">{posts.length} Postingan</p>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                                ...
                                <div className="flex-1 w-full">
                                    <div className="flex flex-col sm:flex-row justify-between sm:items-start w-full">
                                        ...
                                        {isMyProfile && (
                                            <Link href="/profile/edit" className="border border-stone-400 text-stone-800 font-bold px-4 py-1.5 rounded-full hover:bg-stone-100 transition mt-4 sm:mt-0">
                                                Edit Profil
                                            </Link>
                                        )}
                                    </div>
                                    ...
                                    {/* =================================================================== */}
                                    {/* 2. PERUBAHAN UTAMA: Menampilkan 'friendsCount'                      */}
                                    {/* =================================================================== */}
